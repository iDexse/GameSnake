...
class SNAKE:
    ...
    def move_snake(self):
        if self.new_block == True:
            body_snake = self.body[:]
            body_snake.insert(0, body_snake[0] + self.direction)
            self.body = body_snake
            self.new_block = False
        else:
            body_snake = self.body[:-1]
            body_snake.insert(0, body_snake[0] + self.direction)
            self.body = body_snake
    ...
    def update_heading_graphics(self):
...
class MAIN:
    ...
    def draw_score(self):
        ...
        pygame.draw.rect(screen, (56,47,12),bg_rect,2)
